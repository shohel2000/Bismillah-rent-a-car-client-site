                    ...
                    <div style={{display: shippingData ? 'none': 'block'}}>
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="form-group">
                                <input name="name" {...register("name", { required: true })} placeholder="name" className="form-control" defaultValue={loggedInUser.name} />
                                {errors.name && <span>This field is required</span>}
                            </div>
                            <div className="form-group">
                                <input name="email" {...register("email", { required: true })} placeholder="email" className="form-control" defaultValue={loggedInUser.email} />
                                {errors.email && <span>This field is required</span>}
                            </div>
                            <div className="form-group">

                                <input name="service" {...register("service", { required: true })} placeholder="" className="form-control" defaultValue={services.name} />
